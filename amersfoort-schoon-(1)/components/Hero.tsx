...
export const Hero = () => {
  return (
    <section className="relative flex h-[100svh] min-h-[750px] w-full items-center justify-center overflow-hidden bg-primary">
      ...
      <div className="container relative z-10 mx-auto px-6 md:px-12 flex items-center justify-center pt-16">
        <motion.div
          initial={{ opacity: 0, y: 30, scale: 0.95 }}
          animate={{ opacity: 1, y: 0, scale: 1 }}
          transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
          className="max-w-3xl rounded-3xl border border-white/20 bg-white/10 p-8 text-center backdrop-blur-md shadow-[0_30px_60px_rgba(0,0,0,0.2)] md:p-14"
        >
          ...
          <p className="mb-10 text-lg leading-relaxed text-white/90 font-medium max-w-xl mx-auto">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-4 sm:flex-row sm:gap-4">
            ...
            <Link href="#contact" className="w-full sm:w-auto">
              <motion.button
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="group flex w-full items-center justify-center gap-3 rounded-full bg-white px-8 py-5 text-sm font-bold uppercase tracking-widest text-primary shadow-premium transition-all hover:bg-white/90"
              >
                Contact Opnemen
            ...
            <Link href="#meer-weten" className="w-full sm:w-auto">
              <motion.button
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="group flex w-full items-center justify-center gap-3 rounded-full border-2 border-white/50 bg-white/10 px-8 py-5 text-sm font-bold uppercase tracking-widest text-white backdrop-blur-md transition-all hover:bg-white/20 hover:border-white/70"
              >
