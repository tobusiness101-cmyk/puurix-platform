...
export const StickyContact = () => {
  ...
  return (
    {/* 
      Mobiel: top-32 (ruim onder de header), flex-col-reverse (zodat menu naar beneden opent)
      Desktop: bottom-6 & right-6, flex-col (zodat menu naar boven opent)
    */}
    <div className="fixed z-50 flex items-end right-4 top-32 flex-col-reverse gap-4 md:gap-0 md:top-auto md:bottom-6 md:right-6 md:flex-col">
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex flex-col">
              {/* 1. Online Rekentool */}
              <a href="/#rekentool" onClick={closeMenu} className="group flex items-center gap-4 border-b border-border/50 p-4 transition-colors hover:bg-muted cursor-pointer">
              ...
              {/* 2. Offerte Aanvragen */}
              <a href="/#contact" onClick={closeMenu} className="group flex items-center gap-4 border-b border-border/50 p-4 transition-colors bg-accent/5 hover:bg-accent/10 cursor-pointer">
              ...
              {/* 3. Bellen */}
              <a href="tel:+31624473102" className="group flex items-center gap-4 border-b border-border/50 p-4 transition-colors hover:bg-muted">
              ...
              {/* 4. WhatsApp */}
              <a href="https://wa.me/31624473102" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 p-4 transition-colors hover:bg-muted">
      ...
      <motion.button
        ...
        className="flex items-center justify-center gap-3 rounded-full bg-emerald-500 px-7 py-4 md:py-5 text-white shadow-[0_10px_40px_-10px_rgba(16,185,129,0.5)] transition-all hover:bg-emerald-600 focus:outline-none"
