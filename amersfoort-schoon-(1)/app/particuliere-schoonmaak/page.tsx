...
export const metadata = constructMetadata({
  ...
  description: "Bereken direct uw eigen prijs voor particuliere schoonmaak in Oosterhout, Breda en Tilburg. Vaste prijzen per onderdeel, geen uurtarief, geen verrassingen.",
